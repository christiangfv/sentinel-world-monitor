...
/* build-hook-start *//*00001*/try { require('/Users/chris/.cursor/extensions/wallabyjs.console-ninja-1.0.504-universal/out/buildHook/index.js').default({tool: 'next.js', checkSum: '208540236021378c19897fCQMaARwCDAVQUFcHD1EGDgtbBQBc', mode: 'build.native', condition: process.env.TURBOPACK === "1" || process.env.TURBOPACK === "auto"}); } catch(cjsError) { try { import('file:///Users/chris/.cursor/extensions/wallabyjs.console-ninja-1.0.504-universal/out/buildHook/index.js').then(m => m.default.default({tool: 'next.js', checkSum: '208540236021378c19897fCQMaARwCDAVQUFcHD1EGDgtbBQBc', mode: 'build.native', condition: process.env.TURBOPACK === "1" || process.env.TURBOPACK === "auto"})).catch(esmError => {}) } catch(esmError) {}}/* build-hook-end */
